...
lcChi2026 <- lcChi2021$set('system:time_start', ee$Date$fromYMD(2026, 1, 1))$set('year',2026);


collAnn <- ee$ImageCollection(c(lcChi2001, lcChi2002, lcChi2003, lcChi2004, lcChi2005, lcChi2006, lcChi2007, lcChi2008, lcChi2009, lcChi2010, lcChi2011, lcChi2012, lcChi2013, lcChi2014, lcChi2015, lcChi2016, lcChi2017, lcChi2018, lcChi2019, lcChi2020, lcChi2021, lcChi2022, lcChi2023, lcChi2024, lcChi2025, lcChi2026))
...
saveLandCover <- ee_image_to_asset(lcChiAnn, description="Save_NLCD-Chicago_AnnualDupe_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_AnnualDupe_2000-2026"), maxPixels = 10e9, scale=30, region = chiBounds, crs=projCRS, overwrite=T)
saveLandCover$start()
...
saveForMask <- ee_image_to_asset(forMask, description="Save_lcMask-Forest_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_2000-2026_Forest"), maxPixels = 10e9, scale=30, region = chiBounds, crs="EPSG:4326", overwrite=T)
saveForMask$start()
# nlcdProj
...
saveForWetMask <- ee_image_to_asset(forWetMask, description="Save_lcMask-Forest-with-Wet_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_2000-2026_Forest-with-Wet"), maxPixels = 10e9, scale=30, region = chiBounds, crs="EPSG:4326", overwrite=T)
...
saveGrassMask <- ee_image_to_asset(grassMask, description="Save_lcMask-Grass_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_2000-2026_Grass"), maxPixels = 10e9, scale=30, region = chiBounds, crs="EPSG:4326", overwrite=T)
saveGrassMask$start()
...
saveCropMask <- ee_image_to_asset(cropMask, description="Save_lcMask-Crop_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_2000-2026_Crop"), maxPixels = 10e9, scale=30, region = chiBounds, crs="EPSG:4326", overwrite=T)
saveCropMask$start()
...
saveUrbOMask <- ee_image_to_asset(urbOMask, description="Save_lcMask-Urban-Open_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_2000-2026_Urban-Open"), maxPixels = 10e9, scale=30, region = chiBounds, crs="EPSG:4326", overwrite=T)
saveUrbOMask$start()
...
saveUrbLMask <- ee_image_to_asset(urbLMask, description="Save_lcMask-Urban-Low_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_2000-2026_Urban-Low"), maxPixels = 10e9, scale=30, region = chiBounds, crs="EPSG:4326", overwrite=T)
saveUrbLMask$start()
...
saveUrbMMask <- ee_image_to_asset(urbMMask, description="Save_lcMask-Urban-Medium_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_2000-2026_Urban-Medium"), maxPixels = 10e9, scale=30, region = chiBounds, crs="EPSG:4326", overwrite=T)
saveUrbMMask$start()
...
saveUrbHMask <- ee_image_to_asset(urbHMask, description="Save_lcMask-Urban-High_2000-2026", assetId=file.path(assetHome, "NLCD-Chicago_2000-2026_Urban-High"), maxPixels = 10e9, scale=30, region = chiBounds, crs="EPSG:4326", overwrite=T)
saveUrbHMask$start()
##################### 
